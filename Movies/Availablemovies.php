...
$sql = "SELECT movie_id, Title, Description, Duration, URL, Genre, Thumbnail FROM movies";
...
.table td {
    ...
    word-break: break-all; /* Ensure long URLs are broken into lines */
}
.table tbody tr {
    min-height: 140px; /* Set a minimum height for all rows */
    height: auto; /* Allow rows to expand if needed */
